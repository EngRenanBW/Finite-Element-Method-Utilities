...
function mtr_transposta=trans(ang)% o angulo deve ser dado em graus
  ang=ang/180*pi;% transformando em radianos
  
  mtr_transposta=[[cos(ang),sin(ang),0,0];[-sin(ang),cos(ang),0,0];[0,0,cos(ang),sin(ang)];[0,0,-sin(ang),cos(ang)]];
